...
const publicKey = new web3.PublicKey(newPair._keypair.publicKey).toString(); // extracting the public key from accountInfo
const secretKey = newPair._keypair.secretKey; // extracting the private key from accountInfo
const connection = new web3.Connection(
  web3.clusterApiUrl("devnet"),
  "confirmed"
); //Creates a connection object that will be used to get the balance on devnet.
const myWallet = web3.Keypair.fromSecretKey(secretKey); //Creates a keypair object from the private key.
const pub = new web3.PublicKey(myWallet.publicKey); // public key instance
